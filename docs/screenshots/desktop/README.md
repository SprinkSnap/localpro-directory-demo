# Desktop screenshots — LocalPro Directory

Recommended case-study captures at Desktop Chrome 1440×900 (1440×900 @2x).
...
Optional: `PLAYWRIGHT_BASE_URL=https://localprodirectory.chexustudio.com npm run screenshots:desktop`
